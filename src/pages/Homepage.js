    ...
    return(
        <div className="container">
            ...
            <div className="col-8 my-auto">
                ...
                <Link to={"/project"} state={{ some: projects[index].name }}><RoughNotation strokeWidth="2" type="underline" color="#ddd7d5" show="true"><h1 className="project-name">{projects[index].name}</h1></RoughNotation></Link><p>{projects[index].word1}</p><p>{projects[index].word2}</p><p>{projects[index].word3}</p>
                </div>
            </div>
            <div className="col-4">
